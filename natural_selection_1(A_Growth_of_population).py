'''MODEL3: In this program, we will have a species inside a close environment where they have to survive and reproduce by consuming resources which will be originating in the environment at random locations at beginning of the day. In order to survive throught the day, species has to eat some minimum amount of food and to repoduce, some additional minimum amount of food. Each organism will move in radom direction to search the food with a given velocity and if food is in its sensing area, it will move towards it directly and will eat it at some distance.'''
